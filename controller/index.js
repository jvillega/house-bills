...
router.get('/',function(req,res) {
  ...
  bills_functions.GetAllInformation(next_month,function (err,rent,deposit,utilities,tenants,rent_payments,utility_payments) {
    res.render('index.ejs',{rent:rent,deposit:deposit,utilities:utilities,tenants:tenants,rent_payments:rent_payments,utility_payments:utility_payments});
  });
});
